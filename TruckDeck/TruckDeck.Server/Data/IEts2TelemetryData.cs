...
namespace Funbit.Ets.Telemetry.Server.Data
{
    ...
    public interface IEts2Game
    {
        ...
        /// <summary>
        /// Offset from local economy game time to Convoy multiplayer server game time, in in-game minutes.
        /// Zero when multiplayer is not active.
        /// </summary>
        long MultiplayerTimeOffset { get; }
    }
    ...
    public interface IEts2Truck
    {
        ...
        /// </summary>
        bool LightsHazardOn { get; }

        /// <summary>
        /// Is the differential lock enabled or not.
        /// </summary>
        bool DifferentialLockOn { get; }
        ...
        /// <summary>
        /// Current level of the retarder (RenCloud SDK field).
        /// </summary>
        int RetarderLevel { get; }

        /// <summary>
        /// Auxiliary front lights intensity level.
        /// </summary>
        int LightsAuxFrontValue { get; }

        /// <summary>
        /// Auxiliary roof lights intensity level.
        /// </summary>
        int LightsAuxRoofValue { get; }
    ...
    public interface IEts2Navigation
    {
        ...
        /// <summary>
        /// Total route distance in meters (RenCloud SDK field).
        /// </summary>
        float RouteDistance { get; }

        /// <summary>
        /// Total route time in seconds (RenCloud SDK field).
        /// </summary>
        float RouteTimeSeconds { get; }
    }
    ...
    public interface IEts2Job
    {
        ...
        /// <summary>
        /// Planned job distance in simulated kilometers (RenCloud SDK field).
        /// </summary>
