...
namespace Funbit.Ets.Telemetry.Server.Data
{
    ...
    class Ets2Game : IEts2Game
    {
        ...
        public long MultiplayerTimeOffset => 0;
    }
    ...
    class Ets2Truck : IEts2Truck
    {
        ...
        public bool LightsHazardOn => false;
        public bool DifferentialLockOn => false;
        public bool LiftAxleOn => false;
        public bool LiftAxleIndicatorOn => false;
        public bool TrailerLiftAxleOn => false;
        public bool TrailerLiftAxleIndicatorOn => false;
        public float FuelRange => 0;
        public int RetarderLevel => RetarderBrake;
        public int LightsAuxFrontValue => _rawData.Struct.lightsAuxFront;
        public int LightsAuxRoofValue => _rawData.Struct.lightsAuxRoof;
    }
    ...
    class Ets2Navigation : IEts2Navigation
    {
        ...
        public float RouteTimeSeconds => 0;
    }
    ...
    class Ets2Job : IEts2Job
    {
        ...
        public int PlannedDistanceKm => 0;
    }
