/*
    TruckDeck Volvo — digital cluster skin.
    Feature parity with TruckDeckDash; Volvo digital layout.
*/

Funbit.Ets.Telemetry.Dashboard.prototype.initialize = function (skinConfig, utils) {
    var self = this;
    var BRIDGE_PORT = 25556;
    var SKIN = '.dashboard.volvo-digital';
    ...
    for (var ai = 0; ai < this.accents.length; ai++) {
        if (this.accents[ai][0] === (savedAccent || 'blue')) { this.accentIdx = ai; break; }
    }
    this.barHorizontal = true;
    function applyTheme() {
...
Funbit.Ets.Telemetry.Dashboard.prototype.filter = function (data, utils) {
    ...
    $('.speed-bar .sc-gauge-big, .man-speed-big, .daf-speed, .ren-speed, .merc-speed-big').removeClass('zone-ok zone-warn zone-over zone-neutral')
        .addClass('zone-' + speedZone);
    ...
    $('.js-rpm-bar').css(barProp, rpmFrac + '%')
