/*
    TruckDeck Renault — digital cluster skin.
    Feature parity with TruckDeckDash; Renault digital layout.
*/

Funbit.Ets.Telemetry.Dashboard.prototype.initialize = function (skinConfig, utils) {
    var self = this;
    var BRIDGE_PORT = 25556;
    var SKIN = '.dashboard.renault-digital';
    ...
    for (var ai = 0; ai < this.accents.length; ai++) {
        if (this.accents[ai][0] === (savedAccent || 'amber')) { this.accentIdx = ai; break; }
    }
