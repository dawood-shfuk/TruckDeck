/*
    TruckDeck MAN — digital cluster skin.
    Feature parity with TruckDeckDash; MAN digital layout.
*/

Funbit.Ets.Telemetry.Dashboard.prototype.initialize = function (skinConfig, utils) {
    var self = this;
    var BRIDGE_PORT = 25556;
    var SKIN = '.dashboard.man-digital';
    ...
    for (var ai = 0; ai < this.accents.length; ai++) {
        if (this.accents[ai][0] === (savedAccent || 'red')) { this.accentIdx = ai; break; }
    }
...
Funbit.Ets.Telemetry.Dashboard.prototype.filter = function (data, utils) {
    ...
    $('.man-speed-big, .speed-bar .sc-gauge-big').removeClass('zone-ok zone-warn zone-over zone-neutral')
        .addClass('zone-' + speedZone);
